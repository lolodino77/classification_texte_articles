...
# exemple de commande :
# python 1_create_final_corpus.py dataset_baptism_fr.csv dataset_philosophy_fr.csv csv french
# python 1_create_final_corpus.py corpus_edwardfeser.csv corpus_alexanderpruss.csv csv english
# python 1_create_final_corpus.py corpus_edwardfeser.csv corpus_alexanderpruss.csv parquet english
...
print("topics =", topics)
final_corpus_name = "data_{}_{}.".format(topic_1, topic_2) + output_extension
