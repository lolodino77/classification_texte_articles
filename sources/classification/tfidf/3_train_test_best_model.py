...
get_confusion_matrix(y_test, y_pred, class_names, model, savefig=True, dataset_name=corpus_name)

# Courbe ROC
get_roc(model, y_test, y_pred, savefig=True, dataset_name=corpus_name)